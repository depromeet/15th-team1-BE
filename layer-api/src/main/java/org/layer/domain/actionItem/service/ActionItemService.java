...
public class ActionItemService {
    ...
    @Transactional
    public CreateActionItemResponse createActionItem(Long memberId, Long spaceId, String content) {
    ...
    public List<MemberActionItemResponse> getMemberActionItemList(Long currentMemberId) {
        List<ActionItem> actionItemList = actionItemRepository.findAllByMemberIdOrderByCreatedAtDesc(currentMemberId);
